  ...
  return (
    <main>
      <div className="relative h-90">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(10,25,35,0.5),rgba(10,25,35,0.75))]" />
        <Container className="relative z-10 h-full flex flex-col justify-end pb-10 text-white">
