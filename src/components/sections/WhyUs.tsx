    ...
    <section id="about" className="bg-cream py-20">
      <Container className="grid grid-cols-[1.05fr_0.95fr] gap-14 items-center">
        <div>
          ...
          <h2 className="text-[36px] leading-tight max-w-[480px] mb-4 text-navy">
            Trusted by Thousands, Chosen for a{" "}
            <span className="text-orange">Reason</span>
          </h2>
          <p className="text-[15.5px] text-muted max-w-[460px] mb-8">
          ...
          <div className="flex gap-3.5">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="flex-1 flex items-center gap-3 bg-white border border-line rounded-xl px-[18px] py-4"
              >
        ...
        <div className="grid grid-cols-[1.1fr_1fr] gap-3.5">
          ...
          <div className="flex flex-col gap-3.5">
            <div className="relative h-[170px] rounded-brand overflow-hidden">
              <Image
